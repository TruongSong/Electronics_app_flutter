import 'package:electronics_app/commom/widgets/custom_button.dart';
...
import 'package:electronics_app/features/cart/widgets/cart_product.dart';
import 'package:electronics_app/features/cart/widgets/cart_subtotal.dart';
          ...
          children: [
            ...
            if (user.cart.isNotEmpty)
              Padding(
                ...
                child: CustomButton(
                  text: 'Proceed to Buy (${user.cart.length} products)',
